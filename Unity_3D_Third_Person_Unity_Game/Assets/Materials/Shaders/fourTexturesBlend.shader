Shader "Custom/fourTexturesBlend"
{
		...
		SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			...
			fixed3 mix3 = lerp(mix2.rgb, fourth.rgb, filter.b);
			o.Albedo = mix3;
			//o.Albedo = lerp(main.rgb, sec.rgb, filter.b);
			//o.Albedo = lerp(o.Albedo, third.rgb, filter.g);
			//o.Albedo = lerp(o.Albedo, fourth.rgb, filter.r);
			//o.Albedo.g = lerp(main.rgb, sec.rgb, filter.a).g;
			o.Alpha = main.a;
		}
		ENDCG
	}
